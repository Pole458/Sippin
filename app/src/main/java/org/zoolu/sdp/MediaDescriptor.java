...
public class MediaDescriptor {
    ...
    MediaDescriptor(MediaDescriptor md) {
        ...
        for (int i=0; i<md.av.size(); i++)
            av.addElement(new AttributeField(md.av.elementAt(i)));
    }
    ...
    private MediaDescriptor addAttribute(AttributeField attribute) {
        av.addElement(new AttributeField(attribute));
        return this;
    }

    /** Adds a new attributes.
     * @param attributes the new AttributeField
     * @return this MediaDescriptor */
    ...
    /** Gets a String representation of the MediaDescriptor.
